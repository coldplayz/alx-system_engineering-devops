...
* 10:34: A `curl` request was made to the server. Returns a 500 response status code detected by the engineer as shown in the following image: ![error response](https://github.com/coldplayz/alx-system_engineering-devops/blob/main/0x19-postmortem/error_response.jpg "Error response on curl")
